...
def train_model(dataset, batch_size=32, num_epochs=5, learning_rate=0.001, 
               save_path='alter_move_prob_train/data/alter_move_prob_nn.pth', rank_cutoff=3):
    """
    ...
    best_model_path = 'alter_move_prob_train/data/alter_move_prob_nn_best.pth'
    ...
    for epoch in range(num_epochs):
        ...
        if valid_samples > 0:
            ...
            print(f"Epoch {epoch+1}/{num_epochs}, Loss: {avg_loss:.4f}, Valid batches: {valid_samples}/{len(data_loader)}")
...
def main():
    ...
    # Create the dataset
    dataset = AlterMoveProbDataset(latest_data_file)
    print(f"Dataset size: {len(dataset)} samples")
    
    # Train the model with default rank_cutoff=3
    train_model(dataset, num_epochs=10, rank_cutoff=3, learning_rate=0.00005)
