...
def main():
    ...
    data_files = glob.glob('alter_move_prob_train/data/training_data_*.csv')
    if not data_files:
    ...
    model_files = glob.glob('alter_move_prob_train/data/alter_move_prob_nn*.pth')
    if not model_files:
    ...
    metrics_file = f'alter_move_prob_train/data/evaluation_metrics_{timestamp}.txt'
