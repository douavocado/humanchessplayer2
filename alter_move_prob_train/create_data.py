...
def main(max_games_per_file=None, existing_file=None, start_from_pgn=None):
    ...
    # joblib.dump(clf, 'alter_move_prob_train/data/model_selector_clf.joblib')
    ...
    if existing_file:
        ...
        output_file = f'alter_move_prob_train/data/training_data_{timestamp}.csv'
    ...
    with open(output_file, file_mode, newline='', encoding='utf-8') as csvfile:
        ...
        pgn_files = glob.glob('train_PGNs/*.pgn')
