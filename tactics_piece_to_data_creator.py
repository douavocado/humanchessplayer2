...
PGN_DIR = 'train_PGNs/tactics'

SAVE_DST_ROOT = os.path.join("models", "data", "tactics", "piece_to")
SAVE_EVERY = 1000
MAX_GAMES = 100000
test_prob = 0.2
    ...
    for pgn_batch in tqdm(os.listdir(PGN_DIR)):
        ...
        while True:
            ...
            for move in list(game.mainline_moves()):
                # only consider moves when its the solver's turn
            ...
            if game_count % SAVE_EVERY == 0:
                create_data(train_input, train_moved_to, test_input, test_moved_to)
                train_input, train_moved_to = [], []
                test_input, test_moved_to = [], []
                print('games processed', game_count)
