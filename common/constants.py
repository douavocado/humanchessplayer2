...
MOVE_FROM_WEIGHTS_TACTICS_PTH = 'models/model_weights/piece_selector_tactics_weights.pth'
...
MOVE_TO_WEIGHTS_TACTICS_PTH = 'models/model_weights/piece_to_tactics_weights.pth'

QUICKNESS = 2.3 # adjust depending on computer fastness. The bigger the number the slower the moves made
