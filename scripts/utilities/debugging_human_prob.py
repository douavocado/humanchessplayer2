...
# Randomly select a PGN file from the train_PGNs directory
pgn_file = random.choice(os.listdir("assets/data/train_PGNs"))
pgn_path = os.path.join("assets/data/train_PGNs", pgn_file)
