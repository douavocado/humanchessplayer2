...
train_data_file = 'models/data/tactics/piece_selector/train/'
test_data_file = 'models/data/tactics/piece_selector/test/'
...
for t in range(epochs):
    ...
    if test_loss < best_loss:
        best_loss = test_loss
        torch.save(model.state_dict(), 'models/model_weights/piece_selector_tactics_weights.pth')
