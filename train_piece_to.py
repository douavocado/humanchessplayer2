...
train_data_file = 'models/data/tactics/piece_to/train'
test_data_file = 'models/data/tactics/piece_to/test'
...
weights = torch.load('models/model_weights/piece_to_tactics_weights.pth', weights_only=True)
...
for t in range(epochs):
    ...
    if test_loss < best_loss:
        best_loss = test_loss
        torch.save(model.state_dict(), 'models/model_weights/piece_to_tactics_weights.pth')
